...
def upload_file(file_path):
    ...
    # ── Mud Water ──────────────────────────────────────────────────────────
    water_header = find_section_start(df, 'Properties - water|Properties - Water|Mud Water', column=0)
...
# ── Mud Rheology table ──────────────────────────────────────────
    rheo_header = find_section_start(df, 'Rheology|Rheo|Gel Strength', column=0)
    if rheo_header is not None:
