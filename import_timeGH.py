...
logger = logging.getLogger()# timeGH.py - Production importer for high-frequency drilling time records
import pandas as pd
import os
from tqdm import tqdm
import logging
...
def normalize_name(name):
    ...
    # Bulletproof cleaning for EVERY possible variation (Fed Fed, extra spaces, case, etc.)
...
def find_well_id(filename):
    ...
    # 2. Bulletproof normalized guesses
